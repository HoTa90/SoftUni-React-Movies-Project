...
export default function HeroCard({ data, type }) {
    ...
    return (
        <Link
            to={`/${type}/${data?.id}`}
            className="bg-[#191638] p-6 rounded-3xl shadow-2xl shadow-[#a8b5db]/30 relative block transform transition-all duration-300 hover:scale-112 hover:shadow-[#a8b5db]/50 hover:z-10"
        >
            <img 
